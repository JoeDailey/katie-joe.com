...
const unit = {
  days: [
    document.querySelector('.digit[day="0"]'),
    document.querySelector('.digit[day="1"]'),
    document.querySelector('.digit[day="2"]'),
  ],
  hours: [
    document.querySelector('.digit[hour="0"]'),
    document.querySelector('.digit[hour="1"]'),
  ],
  minutes: [
    document.querySelector('.digit[min="0"]'),
    document.querySelector('.digit[min="1"]'),
  ],
  seconds: [
    document.querySelector('.digit[sec="0"]'),
    document.querySelector('.digit[sec="1"]'),
  ],
};
